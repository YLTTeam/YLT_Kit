...
+ (BOOL)isValidPageData:(AppSectionModel *)data {
    return (
            ([data isKindOfClass:AppSectionModel.class] &&
...
+ (void)registerCellToCollectionView:(UICollectionView *)collectionView {
    [collectionView registerCell:@[@"AppPageCell", @"AppBannerCell", @"AppMenuCell", @"AppCourseCell", @"CourseProductCell", @"InputDataCell", @"AddressInputCell", @"AddressListCell", @"MineSingleCell", @"HomeCourseCell", @"MusicTypeCell", @"MusicBannerCell", @"BCEduBoxCell", @"GoodsItemCell", @"ProductRecommendCell", @"CartCell", @"OrderProductCell", @"AddressTipCell", @"GroupUpPhotoCell", @"HomeBrandCell", @"HomeTeacherCell"]];
    
    NSArray<NSString *> *reusableList = @[@"AppNormalReusableView", @"CourseHeaderReusableView", @"CourseWeekHeaderReusableView", @"TotalPriceReusableView", @"MineHeaderReusableView", @"AppPageReusableView", @"MallGoodsTypeReusableView", @"CartHeaderReusableView"];
